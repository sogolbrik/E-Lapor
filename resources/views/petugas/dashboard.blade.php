<x-petugas-layout title="Dashboard Petugas">
    ...
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Ringkasan aduan dan penanganan wilayah kerja <span class="font-semibold text-slate-700">Desa
                    Harapan</span>.
            </p>
        </div>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 transition hover:shadow-md">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-slate-800">42</h3>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 transition hover:shadow-md">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-amber-600">5</h3>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 transition hover:shadow-md">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-indigo-600">12</h3>
                    <p class="mt-2 flex items-center gap-1 text-xs text-slate-500">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 transition hover:shadow-md">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-emerald-600">25</h3>
    ...
    {{-- Alert Tindakan Cepat (Penambahan Nilai Tambah UX Petugas) --}}
    <div
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h4 class="text-xs font-bold text-amber-900">Ada 5 Aduan Masuk Membutuhkan Tanggapan Anda</h4>
                <p class="text-xs text-amber-700 mt-0.5">Segera beri kepastian status (Diproses / Ditolak) agar warga
                    mendapatkan pembaruan.</p>
            </div>
        </div>
        <a href="#tabel-aduan-perlu-tindakan"
        ...
        <div class="flex flex-col gap-4 border-b border-slate-100 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-xs text-slate-500">
                    Daftar laporan masyarakat di Desa Harapan yang belum selesai penanganannya.
                </p>
            </div>
            <a href="#"
            ...
            <table class="w-full text-left text-xs text-slate-600">
                ...
                <tbody class="divide-y divide-slate-100 bg-white font-medium">
                    ...
                    <tr class="hover:bg-slate-50/70 transition">
                        <td class="px-6 py-4 font-mono font-bold text-blue-600">ADU-20260818-0045</td>
                        <td class="px-6 py-4">
                            <span class="font-bold text-slate-800 block">Budi Santoso</span>
                            <span class="text-[10px] text-slate-400">081234567890</span>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-800">Lampu Jalan Utama Mati</p>
                            <span
                                class="inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-semibold text-slate-600 mt-1">Fasilitas
                                Umum</span>
                        </td>
                        <td class="px-6 py-4 text-slate-500">
                            <span>Jl. Mawar No. 12, RT 02 / RW 01</span>
                        </td>
                        <td class="px-6 py-4 text-slate-400">18 Agt 2026, 09:15</td>
                        <td class="px-6 py-4">
                            <span
                    ...
                    {{-- Row 2: Menunggu --}}
                    <tr class="hover:bg-slate-50/70 transition">
                        <td class="px-6 py-4 font-mono font-bold text-blue-600">ADU-20260818-0041</td>
                        <td class="px-6 py-4">
                            <span class="font-bold text-slate-800 block">Anonim</span>
                            <span class="text-[10px] text-slate-400">Identitas Disembunyikan</span>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-800">Sampah Menumpuk di Saluran Air</p>
                            <span
                                class="inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-semibold text-slate-600 mt-1">Kebersihan
                                Lingkungan</span>
                        </td>
                        <td class="px-6 py-4 text-slate-500">
                            <span>Depan Lapangan Voli Desa</span>
                        </td>
                        <td class="px-6 py-4 text-slate-400">17 Agt 2026, 16:30</td>
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-2.5 py-1 text-[11px] font-semibold text-amber-700 ring-1 ring-inset ring-amber-600/20">
                                <span class="h-1.5 w-1.5 rounded-full bg-amber-500"></span> Menunggu
                    ...
                    {{-- Row 3: Diproses --}}
                    <tr class="hover:bg-slate-50/70 transition">
                        <td class="px-6 py-4 font-mono font-bold text-blue-600">ADU-20260815-0038</td>
                        <td class="px-6 py-4">
                            <span class="font-bold text-slate-800 block">Siti Rahma</span>
                            <span class="text-[10px] text-slate-400">085678901234</span>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-800">Jalan Berlubang Cukup Dalam</p>
                            <span
                                class="inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-semibold text-slate-600 mt-1">Infrastruktur</span>
                        </td>
                        <td class="px-6 py-4 text-slate-500">
                            <span>Pertigaan Dusun Krajan</span>
                        </td>
                        <td class="px-6 py-4 text-slate-400">15 Agt 2026, 11:00</td>
                        <td class="px-6 py-4">
                            <span
                    ...
                    {{-- Row 4: Diproses --}}
                    <tr class="hover:bg-slate-50/70 transition">
                        <td class="px-6 py-4 font-mono font-bold text-blue-600">ADU-20260814-0032</td>
                        <td class="px-6 py-4">
                            <span class="font-bold text-slate-800 block">Agus Kurniawan</span>
                            <span class="text-[10px] text-slate-400">081987654321</span>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-800">Pohon Lapuk Berbahaya di Tepi Jalan</p>
                            <span
                                class="inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-semibold text-slate-600 mt-1">Gangguan
                                Ketertiban</span>
                        </td>
                        <td class="px-6 py-4 text-slate-500">
                            <span>Dekat Balai Desa Harapan</span>
                        </td>
                        <td class="px-6 py-4 text-slate-400">14 Agt 2026, 08:20</td>
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-semibold text-blue-700 ring-1 ring-inset ring-blue-600/20">
                                <span class="h-1.5 w-1.5 rounded-full bg-blue-500"></span> Diproses
