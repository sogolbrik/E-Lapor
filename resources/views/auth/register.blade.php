        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white border border-[#E2E8F0] rounded-2xl shadow-sm p-6 sm:p-8">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-12 h-12 bg-[#2563EB]/10 rounded-xl text-[#2563EB] mb-3 text-xl">
                        <i class="fa-solid fa-user-plus"></i>
                    </div>
                    <h1 class="text-2xl font-bold text-[#1E293B] mb-2">Pendaftaran Akun Baru</h1>
                    <p class="text-xs sm:text-sm text-[#1E293B]/70">Lengkapi data diri Anda sesuai NIK untuk mulai menyampaikan laporan dan aspirasi.</p>
                </div>

                <!-- Session Alert Status -->
                @if (session('status'))
                    <div class="mb-6 p-4 rounded-xl bg-[#10B981]/10 border border-[#10B981]/30 text-[#10B981] text-xs font-medium flex items-center gap-2">
                ...
                @if ($errors->any())
                    <div class="mb-6 p-4 rounded-xl bg-[#EF4444]/10 border border-[#EF4444]/30 text-[#EF4444] text-xs font-medium">
                ...
                <!-- Form Register -->
                <form method="POST" action="{{ route('register.post') }}" enctype="multipart/form-data" class="space-y-5" x-data="{ avatarPreview: null, showPassword: false, showConfirmPassword: false }">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <!-- Field NIK -->
                        <div>
                            <label for="nik" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                                NIK (16 Digit) <span class="text-[#EF4444]">*</span>
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-[#1E293B]/40 text-sm">
                                    <i class="fa-solid fa-id-card"></i>
                                </div>
                                <input type="text" id="nik" name="nik" value="{{ old('nik') }}" required autofocus maxlength="16" placeholder="3516xxxxxxxxxxxx" inputmode="numeric"
                        ...
                        <!-- Field Nama Lengkap -->
                        <div>
                            <label for="name" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Nama sesuai KTP"
                        ...
                        <!-- Field Email -->
                        <div>
                            <label for="email" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                        ...
                        <!-- Field No HP -->
                        <div>
                            <label for="no_hp" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                        ...
                        <div class="md:col-span-2">
                            <label for="wilayah_id" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                            ...
                            <div class="relative">
                                ...
                                @if (isset($wilayahs) && count($wilayahs) > 0)
                                    <select id="wilayah_id" name="wilayah_id" required
                                        ...
                                        <option value="" disabled selected>-- Pilih Wilayah / Kelurahan --</option>
                                ...
                                @else
                                    <select id="wilayah_id" name="wilayah_id" required
                                        class="w-full pl-10 pr-4 py-3 bg-[#F8FAFC] border @error('wilayah_id') border-[#EF4444] @else border-[#E2E8F0] @enderror rounded-xl text-sm text-[#1E293B] focus:outline-none focus:border-[#2563EB] focus:bg-white transition duration-200 appearance-none">
                                        <option value="" disabled {{ old('wilayah_id') ? '' : 'selected' }}>-- Pilih Wilayah / Kelurahan --</option>
                                        <option value="1" {{ old('wilayah_id') == '1' ? 'selected' : '' }}>Wilayah Pusat / Kecamatan</option>
                                        <option value="2" {{ old('wilayah_id') == '2' ? 'selected' : '' }}>Kelurahan / Desa 01</option>
                                        <option value="3" {{ old('wilayah_id') == '3' ? 'selected' : '' }}>Kelurahan / Desa 02</option>
                                    </select>
                                @endif
                                <div class="absolute inset-y-0 right-0 pr-3.5 flex items-center pointer-events-none text-[#1E293B]/40 text-xs">
                        ...
                        <!-- Field Password -->
                        <div>
                            <label for="password" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-xs font-semibold text-[#1E293B] uppercase tracking-wider mb-2">
                            ...
                            <div class="relative">
                                ...
                                <input :type="showConfirmPassword ? 'text' : 'password'" id="password_confirmation" name="password_confirmation" required placeholder="••••••••"
                    ...
                    <div class="flex items-start pt-2">
                        ...
                        <label for="terms" class="ml-2 text-xs text-[#1E293B]/70 cursor-pointer select-none">
                            Saya menyatakan bahwa data yang saya masukkan adalah benar dan menyetujui <a href="#" class="text-[#2563EB] hover:underline font-medium">Syarat & Ketentuan</a> E-Lapor.
                        </label>
                    </div>
